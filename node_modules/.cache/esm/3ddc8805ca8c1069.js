let server,port,hardCodedRoutes,dbRoutes;_ca8‍.w("./startScript",[["server",["server"],function(v){server=v}],["port",["port"],function(v){port=v}]]);_ca8‍.w("./routes/hardCodedRoutes.js",[["hardCodedRoutes",["hardCodedRoutes"],function(v){hardCodedRoutes=v}]]);_ca8‍.w("./routes/dbRoutes.js",[["dbRoutes",["dbRoutes"],function(v){dbRoutes=v}]]);console.log(' ./app.js - started with those dependencies: ESM , MySQL, EXPRESS');
